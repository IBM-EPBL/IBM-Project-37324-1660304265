...
def predictSpecies():
    ...
    response_scoring = requests.post('https://eu-de.ml.cloud.ibm.com/ml/v4/deployments/782741b9-1e46-4126-943a-f0696c250c0e/predictions?version=2022-11-07', json=payload_scoring,
